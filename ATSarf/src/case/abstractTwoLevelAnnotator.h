...
private slots:
    void tagMain_clicked() { tagMain_action(); }
    void unTagMain_clicked() { unTagMain_action(); }
    void tagName_clicked() { tagName_action(); }
    void unTagName_clicked() { unTagName_action(); }
    void save_clicked() { save_action(); }
    void text_selectionChanged() { text_selectionChangedAction(); }
    void modifyGraph_clicked() { modifyGraph_action(); }
    void isGlobalGraph_toggled(bool) { isGlobalGraph_action(); }
...
public:
    ...
    QAction *forcePunctuationMainBoundaryAct, *tagMainAct, *unTagMainAct, *forceWordNamesAct, *tagNameAct,
        *unTagNameAct, *saveAct, *modifyGraphAct, *globalGraphAct, *resetGlobalGraphAct;
    QMenu *viewMenu;
