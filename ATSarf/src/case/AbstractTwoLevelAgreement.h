...
private:
    ...
    QVector<double> nameRecallList, namePrecisionList, underNameRecallList, underNamePrecisionList, boundaryRecallList,
        boundaryPrecisionList, underBoundaryRecallList, underBoundaryPrecisionList;
...
public: // statistics:
    ...
    double segmentationRecall, segmentationPrecision, underSegmentationRatio, nameRecall, namePrecision, boundaryRecall,
        boundaryPrecision, underNameRecall, underNamePrecision, underBoundaryRecall, underBoundaryPrecision;
...
int commonNames(QString *text, const AbstractTwoLevelAgreement::SelectionList &list1,
    ...
    for (int i = 0; i < list1.size(); i++) {
        ...
        int start1 = list1[i].first, end1 = list1[i].second;
        for (int j = 0; j < list2.size(); j++) {
            int start2 = list2[j].first, end2 = list2[j].second;
